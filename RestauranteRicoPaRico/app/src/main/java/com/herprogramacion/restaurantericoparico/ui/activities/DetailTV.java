...
public class DetailTV extends AppCompatActivity {
    ...
    public void addfav(View v) {
        ...
        search = Find.findFavTV(book.getOpenLibraryId());
        if (search == -1) {
            Singleton.getInstance().addToArray(book.getOpenLibraryId());
            Comidas.SeriesFav.add(new Comida(book.getOpenLibraryId(), book.getStars(), book.getname(), book.getImg(), book.getAuthor(), 3f, 1, 778, "03/24/2017", book.getImg()));
